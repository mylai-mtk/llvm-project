...
CodeGenModule::CodeGenModule(ASTContext &C,
  ...
  if (LangOpts.Sanitize.has(SanitizerKind::KCFI))
    ...
    switch (LangOpts.getZicfilpLabelScheme()) {
      case LangOptionsBase::RISCVZicfilpLabelSchemeKind::None:
        CFITypeIdScheme = CFITypeIdSchemeKind::None;
        break;
      case LangOptionsBase::RISCVZicfilpLabelSchemeKind::Simple:
        CFITypeIdScheme = CFITypeIdSchemeKind::RISCVZicfilpSimple;
        break;
      case LangOptionsBase::RISCVZicfilpLabelSchemeKind::FuncSig:
